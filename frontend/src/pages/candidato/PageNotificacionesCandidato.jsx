...
import { Seccion1PageNotificacionesCandidato } from '../../components/candidato/Seccion1PageNotificacionesCandidato';

export const PageNotificacionesCandidato = ({ candidato }) => {
    ...
    return (
        <div className='contenedor-todo contenedor-seccion-notificaciones w-100'>
            ...
            <div className='w-100 pb-4'>
                <Seccion1PageNotificacionesCandidato 
