...
import { Seccion1PagePerfilEmpresa } from '../../components/admin/Seccion1PagePerfilEmpresa'
import { Seccion2PagePerfilEmpresa } from '../../components/admin/Seccion2PagePerfilEmpresa'
  ...
  return (
      <div className='contenedor-todo'>
        ...
        {seccionActiva === "perfil-publicaciones" && (
            <div className='contenedor-todo'>
                <div className='seccionn container mt-4 d-flex justify-content-center'>
                    <Seccion1PagePerfilEmpresa empresa={empresa} numPublicaciones={numPublicaciones} actualizarFetch={fetchData}/>
                </div>

                <div className='seccionn container mt-4 mb-4 d-flex justify-content-center'>
                    <Seccion2PagePerfilEmpresa empresa={empresa} publicaciones={publicaciones} vacantes={vacantes} manejarMostrarSeccion={manejarMostrarSeccion} manejarMostrarSeccionVacante={manejarMostrarSeccionVacante} mostrarVacantes={mostrarVacantes}/>
                </div>
            </div>
        )}
        ...
        {seccionActiva === "publicacion" && (
            <div className='contenedor-todo'>
                <div className='seccionn container mt-4 mb-4 d-flex justify-content-center'>
                    <SeccionPublicacion empresa={empresa} publicacion={publicacionSeleccionada}  manejarOcultarSeccion={manejarOcultarSeccion} actualizarFetch={fetchData}/>
                </div>
            </div>
        )}
        ...
        {seccionActiva === "detalles-vacante" && (
            <div className='contenedor-seccion-vacantes d-flex flex-column align-items-center w-100 '>
                <div className='w-100 pt-4 pb-4'> 
                    <SeccionVacante empresa={empresa} vacante={vacanteSeleccionada} manejarOcultarSeccionVacante={manejarOcultarSeccionVacante} actualizarFetch={fetchData} />
