        ...
        <div>
            ...
            <div className="contenedor-detalles-candidato">
                ...
                <div className="mb-3">
                  ...
                  <p className="form-control-static">{candidato.email}</p>
                </div>
                <div className="mb-3">
                  <label className="form-label">Correo Verificado</label>
                  <p className="form-control-static">{candidato.Correo_Verificado === "1" ? 'Sí' : 'No'}</p>
                </div>
                <div className="mb-3">
                  <label className="form-label">Estado Cuenta</label>
                  <p className="form-control-static">{candidato.Estado_Cuenta === "1" ? 'Activa' : 'Inactiva'}</p>
                </div>
                <div className="mb-3">
                  <label className="form-label">Fecha Registro</label>
                  <p className="form-control-static">{candidato.Fecha_Registro}</p>
                </div>
                <div className="mb-3">
                  <label className="form-label">Strikes</label>
                  <p className="form-control-static">{candidato.Strikes}</p>
                </div>
                <div className="mb-3">
