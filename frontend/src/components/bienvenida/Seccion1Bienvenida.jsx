    ...
    <div className="container">
      <div className="row align-items-center">
        ...
        <div className="info col-md-6">
          <h2 className="display-1 fw-bold mb-4">CODEMX</h2>
          <p className="text-uppercase fw-semibold fs-4 mb-4">¡El inicio de tu vida profesional!</p>
          <p className="descripcion fs-5">
            Inicia sesión o regístrate en <span className="span fw-semibold">CODEMX</span> para encontrar el trabajo de tus sueños como programador. Al iniciar sesión aceptas los términos de política de privacidad y las condiciones de uso de la plataforma de <span className="span fw-semibold">CODEMX</span>.
          </p>
        </div>
