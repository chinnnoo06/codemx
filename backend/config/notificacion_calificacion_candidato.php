...
try {
    ...
    if (!isset($data['idCandidato']) || !isset($data['candidatoNombre']) || !isset($data['candidatoApellido']) || !isset($data['nombreEmpresa'])) {
    ...
    $descripcion = "¡Hola $candidatoNombre $candidatoApellido! Queremos informarte que $nombreEmpresa ha agregado una nueva calificación a tu perfil. Te invitamos a revisarla cuanto antes, ya que puede influir positivamente en futuras oportunidades dentro de la plataforma. ¡Sigue destacando con tu talento!";
    ...
    try {
        ...
        $mail->Body = "
            ...
            <p style='font-size: 15px;'>Queremos informarte que $nombreEmpresa ha agregado una nueva calificación a tu perfil. Te invitamos a revisarla cuanto antes, ya que puede influir positivamente en futuras oportunidades dentro de la plataforma. ¡Sigue destacando con tu talento!</p>
